...
//        Point a = new Point(this.getX1(),this.getY1());
//        Point b = new Point(Math.min(this.getX1(),this.getY1() - ))
...
//        ///////////////////////////////////
        ...
        this.setCornerPt(new Point(/*this.getX1()*/Math.min(this.getX1(), this.getX2()), this.getY1()));
